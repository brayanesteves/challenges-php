<?php
    ...
    define(  'AUTHENTICATED_LAYOUT',   'authenticated');
    define('UNAUTHENTICATED_LAYOUT', 'unauthenticated');
    define(                  'ROOT', realpath(dirname(__FILE__)) . DS);
    define(    'AUTHENTICATED_ROOT', realpath(dirname(__FILE__)) . DS .'views' . DS . 'layouts' . DS . AUTHENTICATED_LAYOUT   . DS);
    define(  'UNAUTHENTICATED_ROOT', realpath(dirname(__FILE__)) . DS .'views' . DS . 'layouts' . DS . UNAUTHENTICATED_LAYOUT . DS);
